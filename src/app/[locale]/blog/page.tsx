  ...
  const blogs = [
    {
      ...
      desc: "Discover the stunning coastline, rich history, and delicious cuisine of Croatia.",
      date: "2025-09-05",
      image:
    ...
    },
    {
      ...
      desc: "From Paris to Prague, explore the most beautiful cities in Europe for your next holiday.",
      date: "2025-09-02",
      image:
    ...
    },
    {
      ...
      desc: "Experience freedom, adventure, and self-discovery through solo journeys.",
      date: "2025-08-29",
      image:
  ...
  return (
    <div className="w-full overflow-x-hidden">
      ...
      <section className="relative w-full h-[300px] md:h-[400px] overflow-hidden">
        ...
        {/* Custom Banner Info (old joyiga qaytardim) */}
      ...
      <section className="max-w-6xl mx-auto py-12 px-4 space-y-8">
        {blogs.map((blog) => (
          <div
            key={blog.id}
            className="flex flex-col md:flex-row bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300"
          >
            {/* Left side image */}
