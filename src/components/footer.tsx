      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h4 className="text-xs font-bold text-white uppercase tracking-widest">{t("customer_support.follow_us")}</h4>
          ...
          {/* Contact Details */}
          <div>
            <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-8">{t("customer_support.contact_us")}</h4>
            <div className="space-y-6">
              <div className="flex items-start gap-3 group cursor-pointer">
                ...
                <div>
                  ...
                  <a href="tel:+447985269296" className="text-gray-300 hover:text-white transition-colors">+44 79 8526 9296</a>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 gap-8 lg:col-span-1">
            <div>
              <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-8">{t("sections.tours")}</h4>
              <ul className="space-y-3">
                {tours.map((tour) => (
                  <li key={tour.id}>
                    <Link href={`/tour/${tour.slug}`} className="text-sm text-gray-400 hover:text-white transition-colors block py-0.5">
                      {tour.title}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={i}>
                    <Link href={link.href} className="text-sm text-gray-400 hover:text-white transition-colors block py-0.5">
                      {link.label}
                    </Link>
                  </li>
                ))}
