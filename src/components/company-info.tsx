...
import { Users, Globe, Award, Shield, MapPin, Calendar } from "lucide-react";
        ...
        <section id="about" className="py-24 bg-white relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#1a1a1a] tracking-tight mb-6">
                        {t("title")}
                    </h2>
